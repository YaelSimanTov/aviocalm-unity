...
public class GameManagerScript : MonoBehaviour
{
   ...
   [HideInInspector] public float currentTimerTime;
    ...
    private void Start()
    {
        ...
        // Clinical log: Documenting the exposure difficulty level chosen for this session
        Debug.Log($"[System Event] Simulation initialized. Difficulty Level: {LevelDiff.ToString()}");
        ...
        switch (LevelDiff)
        {
            ...
            case LevelDiff.Hard:
               ...
               RainDrops.SetActive(true);
                ...
                // Clinical log: Weather effects are strong anxiety triggers
                Debug.Log("[Flight Event] Environment changed: Heavy rain and storm effects started.");
                break;
        }
    }
    ...
    public void ChangeCurrentState(FlightState newState)
    {
        ...
        // Critical log for the timeline: Marks the backbone of the flight's chronological progression
        Debug.Log($"[Flight Phase] Phase changed to: {newState}");
    ...
    private void HandleInFlight()
    {
        ...
        {
            case LevelDiff.Easy:
              currentTimerTime = timeScript.timerTime = 0.30f * 60f;
                break;
            case LevelDiff.Medium:
              currentTimerTime =  timeScript.timerTime = 0.30f * 60f;
                break;
            case LevelDiff.Hard:
                currentTimerTime = timeScript.timerTime = 2f * 60f;
                break;
        }
    }
    ...
    private IEnumerator unFastenSeatBelt()
    {
        ...
        // Clinical log: The point of relief for the patient
        Debug.Log("[Flight Event] Airplane safely landed. Seatbelt sign is OFF.");
    ...
    private void StartOfTheLanding()
    {
        ...
        // Clinical log: Start of the descent sequence, a common secondary anxiety peak
        Debug.Log("[Flight Event] Landing sequence initiated. Co-pilot announced descent.");
    ...
    private void RandomizeAirPlaneTurbalance()
    {
        ...
        if (ShouldTurblance)
        {
            ...
            // Critical clinical log: Explains sudden heart rate spikes during the "InFlight" phase
            Debug.Log("[Flight Event] Environment changed: Turbulence initiated.");
