...
public class SeatScript : MonoBehaviour
{
    ...
    public void SetPlayerTransform()
    {
        ...
        {
            // Dev log to prevent server clutter on errors
            Debug.LogError("[Dev] Player Is Not Found");
        }
    }

    private void OnMouseDown()
    {
        // Tagged as User Action for the React Timeline
        Debug.Log("[User Action] Patient clicked the chair (Non-VR interface)");
    ...
    public void OnSelectEntered()
    {
        ...
        {
            // Tagged as User Action for the React Timeline
            Debug.Log("[User Action] Patient sat in the airplane seat (VR interface)");
    ...
    public void SeatBeltTutorialMethod(bool isSitting)
    {
        ...
        {
            // Dev log
            Debug.Log("[Dev] Tutorial Spawned!");
            currentSeatBeltTutorial = SpawnTutorial();
        }
    }
    ...
    private void PutSeatBeltOn_NonVr()
    {
        if (Input.GetKeyDown(KeyCode.L) && Player_SeatManager.instance.Is_Sitted)
        {
            if (currentSeatBeltTutorial != null)
            {
                ...
                // Clinical log indicating a significant anxiety trigger point
                Debug.Log("[Flight Event] Patient fastened the seatbelt. Preparing for takeoff.");
    ...
    public void PutSeatBeltOnVr()
    {
        ...
        // Clinical log indicating a significant anxiety trigger point in VR
        Debug.Log("[Flight Event] Patient fastened the seatbelt (VR). Preparing for takeoff.");
    ...
    private void GetUpFromChair()
    {
        ...
        if (shouldGetUp)
        {
            // Optional: You could add a [User Action] log here if you want to track restlessness
            Debug.Log("[User Action] Patient stood up from the seat.");
    ...
    public void GetUpFromChairVr()
    {
        ...
        // Log the final user action of leaving the seat at the end
        Debug.Log("[User Action] Patient stood up from the seat (VR).");
    ...
    public void SpawnSeatBelts_Vr()
    {
        ...
        // Dev log
        Debug.Log("[Dev] Spawned belts Successfully");
    }
    ...
    private void DestroyTutorial(GameObject tutorial)
    {
        if (tutorial != null)
        {
            ...
            // Dev log
            Debug.Log("[Dev] Destroyed Tutorial & Belts");
        }
        else
        {
            // Dev log
            Debug.Log("[Dev] Tutorial is Null: " + tutorial.ToString());
        }
    }
    ...
    private void SpawnNpc(GameObject npcModel)
    {
        ...
        // Dev log
        Debug.Log("[Dev] NPC Customer Spawned!");
    }
}